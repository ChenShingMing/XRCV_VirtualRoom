...
Properties {
    ...
    [NoScaleOffset] _MainTex2 ("Spherical  (HDR)", 2D) = "white" {}
...
SubShader {
        ...
        fixed4 frag (v2f i) : SV_Target
        {
            ...
            half4 tex = tex2D (_MainTex, tc) * (1,1,1,1-_Blend);
            half4 tex2 = tex2D (_MainTex2, tc) * (1,1,1,_Blend);
            ...
            */
            ...
            half4 combine = tex + tex2;
            combine = combine * _Tint.rgba;
